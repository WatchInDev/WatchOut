...
export const firebaseAuthErrorMessages: { [code: string]: string } = {
    ...
    'auth/phone-number-already-exists': 'Podany numer telefonu jest już używany przez innego użytkownika.',
    ...
    'auth/too-many-requests': 'Wykryto zbyt wiele nieudanych prób. Proszę spróbować ponownie później.',
    'auth/internal-error': 'Wystąpił nieoczekiwany błąd serwera. Jeśli problem się powtarza, skontaktuj się ze wsparciem.',
    ...
    'auth/invalid-phone-number': 'Wprowadzony numer telefonu jest nieprawidłowy (wymagany format E.164).',
    'auth/invalid-display-name': 'Nazwa użytkownika jest nieprawidłowa lub pusta.',
    'auth/unauthorized-continue-uri': 'Domena przekierowania nie jest autoryzowana. Skontaktuj się z administratorem.',
    
    // === Błędy Admin SDK (rzadziej na kliencie) ===
    'auth/claims-too-large': 'Nie można ustawić atrybutów: przekroczono limit rozmiaru (1000 bajtów).',
    'auth/uid-already-exists': 'Wewnętrzny identyfikator UID jest już używany przez innego użytkownika.',
