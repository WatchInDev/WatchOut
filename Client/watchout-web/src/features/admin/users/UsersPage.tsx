                  ...
                  <ul className="space-y-2">
                    {eventsQuery.data?.map((e: Event) => {
                      ...
                      return (
                        <li
                          key={e.id}
                          className="p-2 border rounded flex justify-between items-start gap-4"
                        >
                          <div className="flex flex-col gap-1">
                            ...
                            <p className="text-xs opacity-70">
                              Data zgłoszenia:{" "}
                              {new Date(e.reportedDate).toLocaleString()}
                            </p>
      ...
      <Dialog open={!!confirm} onOpenChange={() => setConfirm(null)}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={confirm?.action}>
              Potwierdź
            </Button>
          </DialogFooter>
        </DialogContent>
