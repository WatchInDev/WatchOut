...
INSTALLED_APPS = [
    ...
    'watchout',
    'rest_framework',
    'rest_framework.authtoken', # do I need it?
    'corsheaders',  # do I need them?
    'drf_spectacular',
    'django_extensions',
]

# Whole API by default is accessible via special token
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny'  # We'll handle auth in our custom class
    ],
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Watchout Django microservice',
    'DESCRIPTION': 'Watchout microservice - helper service for main Kotlin backend for scrapping and stuff like this.',
    'VERSION': '0.0.0',
